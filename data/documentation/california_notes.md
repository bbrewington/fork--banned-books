...
**Source:** `data/raw/california/Disapproved Publications - Family & Friends Services.pdf`
**Processed:** `data/processed/cleaned_california.csv`
**Script:** `etl/clean_california.R`

## Overview

- **4,320 entries** across 221 PDF pages
- 3,120 books, 1,200 periodicals
